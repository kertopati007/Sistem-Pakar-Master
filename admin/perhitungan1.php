...
<div class="container-fluid">
    ...
    <div class="col-xl-12 col-md-6 mb-4">
        <div class="card shadow mb-4">
          ...
          <form name=text_form method=POST action='perhitungan1.php ' >
  ...
  <?php
        ...
        echo "
            <input class='float' type=submit data-toggle='tooltip' data-placement='top' title='Klik disini untuk melihat hasil diagnosa' name=submit value='Cek Sekarang' style='font-family:Arial, FontAwesome; width:175px; ' >
            </tbody></table></form>";
                ...
                <?php 
                      ...
                      <h2 class='text text-primary'>Hasil Diagnosis &nbsp;&nbsp;<button id='print' onClick='window.print();' data-toggle='tooltip' data-placement='right' title='Klik tombol ini untuk mencetak hasil diagnosa'><i class='fa fa-print'></i> Cetak</button> </h2>
                        ...
                        echo "<div class='callout callout-default'>Jenis penyakit yang dialami adalah <b><h3 class='text text-success'>" . $nmpkt[1] . "</b> / " . round($vlpkt[1], 2) *100 . " % (" . $vlpkt[1] . ")<br></h3>";
                        echo "</h4></div></div>
