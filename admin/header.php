...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?= ($page=='penyakit')? "active":"" ?>">
      ...
      <li class="nav-item <?= ($page=='gejala')? "active":"" ?>">
      ...
      <li class="nav-item <?= ($page=='riwayat')? "active":"" ?>">
        <a class="nav-link" href="riwayat.php">
          <i class="fas fa-fw fa-history"></i>
          <span>Riwayat</span></a>
      </li>

      <li class="nav-item <?= ($page=='basispengetahuan')? "active":"" ?>">
      ...
      <li class="nav-item <?= ($page=='perhitungan')? "active":"" ?>">
        <a class="nav-link" href="perhitungan.php?act=1">
